...
function calculate(loan_amt, months, rate, extra) {
  ...
  var b1_employer_income = Number.parseInt(document.getElementById("ApplicantIncome").value.replace(/\,/g, ""));
  if (isNaN(b1_employer_income) ){
    b1_employer_income = 0;
  }
  document.getElementById("AppIncome").innerHTML = accounting.formatMoney(b1_employer_income);
  console.log("b1_employer_income _ from-LoanAmJS" + " " + b1_employer_income);

  var b2_employer_income = Number.parseInt(document.getElementById("CoApplicantIncome").value.replace(/\,/g, ""));
   if (isNaN(b2_employer_income) ){
    b2_employer_income = 0;
  }
  document.getElementById("CoApplicantIncome").innerHTML = accounting.formatMoney(b2_employer_income);
  console.log("b2_employer_income _ from-LoanAmJS" + " " + b2_employer_income);

  // parseInt(document.getElementById("CoApplicantIncome").value.replace(/\,/g,""));

  document.getElementById("coAppIncome").innerHTML = accounting.formatMoney(b2_employer_income);

  // console.log("b2_employer_incom_ from-LoanAmJS" + " " + b2_employer_income);


  var b1PLUSb2_income =parseInt(b1_employer_income) + parseInt(b2_employer_income);
  console.log("b1PLUSb2_income _ from-LoanAmJS" + " " + b1PLUSb2_income);

  document.getElementById("grandTotalincome").innerHTML = accounting.formatMoney(b1PLUSb2_income);
  var b1_total_assets = document.getElementById("b1TotalAssets").value;

  document.getElementById("AppTotalAssets").innerHTML = accounting.formatMoney(b1_total_assets);
  ...
  document.getElementById("CoAppTotalAssets").innerHTML = accounting.formatMoney(b2_total_assets);
  console.log("b2_total_assets  _ from- LoanAmJS" + " " + b2_total_assets);

  var b1_total_liabilities = parseInt(document.getElementById("b1TotalMonthlyLiabilities").value.replace(/\,/g, ""));
  document.getElementById("AppTotalLiabilities").innerHTML = accounting.formatMoney(b1_total_liabilities);
  console.log("B1 Liabilites_ from-LoanAmJS" + " " + b1_total_liabilities);

  var b2_total_liabilities = parseInt(document.getElementById("CoTotalMonthlyLiabilities").value.replace(/\,/g, ""));
  document.getElementById("CoAppTotalLiabilities").innerHTML = accounting.formatMoney(b2_total_liabilities);
